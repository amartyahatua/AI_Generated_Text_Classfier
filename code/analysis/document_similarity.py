...
print("{} % document with Cosine similarity 0 to 0.2".format((first_bin/df['Cos Similarity'].shape[0])*100), '.2f')
print("{} % document has Cosine similarity 0.2 to 0.4".format((second_bin/df['Cos Similarity'].shape[0])*100), '.2f')
print("{} % document has Cosine similarity 0.4 to 0.6".format((third_bin/df['Cos Similarity'].shape[0])*100), '.2f')
print("{} % document has Cosine similarity 0.6 to 0.8".format((fourth_bin/df['Cos Similarity'].shape[0])*100), '.2f')
print("{} % document has Cosine similarity 0.8 to 1.0".format((fifth_bin/df['Cos Similarity'].shape[0])*100), '.2f')
